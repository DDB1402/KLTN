...
import { HOST_NAME, iconFolder, MESSAGE_TYPE } from "./constants";
...
export const handleUploadFile = (
  ...
  //   if (requestFile?.singleFile) {
  //     const singleFile = requestFile.singleFile[0];

  //     let info = handleRenameIconFile(req, singleFile);
  //     fileInfos.push(info);
  //   } else if (requestFile?.multipleFile) {
  //     const fileList = requestFile.multipleFile;
  //     fileList.forEach((file: Express.Multer.File, index: number) => {
  //       fileInfos.push(handleRenameIconFile(req, file));
  //     });
  //   }
